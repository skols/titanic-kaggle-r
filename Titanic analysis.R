...
# Buid the model(note: not all possible variables are used)
...
# This shows that we're more successful at predicting death than survival
...
write.csv(solution, file="rf_mod_Solution.csv", row.names=T)
